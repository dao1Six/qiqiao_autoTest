...
class MbCapitalAppTest_001(unittest.TestCase):
    ...
    def test_01( self ):
        ...
        formPage.MbMultiForm_AddButton_Click("领用明细")
    ...
    def test_02( self ):
        ...
        formPage = MbFormPage(self.driver)
        formPage.MbMultiForm_AddButton_Click("维修明细")
        formPage.MbMultiForm_BathManagePage_Record_Tick("维修明细", [1, 2])
        formPage.MbMultiForm_BathManagePage_Button_Cick("维修明细","确定选择")
        formPage.MbForm_Button_Click("提交")
        formPage.MbForm_ProcessHandle_Pop_QuerenButton_Click()
        self.assertIn('成功', formPage.Public_GetAlertMessage(), msg="第一个人工任务办理失败")
        time.sleep(5)
        ...
        self.driver.back()
        todoPage.MbTodoPage_ProcessRecord_Click(1)
        formPage.MbForm_Button_Click("接收设备")
        formPage.MbForm_ProcessHandle_Pop_QuerenButton_Click()
        self.assertIn('成功', formPage.Public_GetAlertMessage(), msg="第二个人工任务办理失败")
        time.sleep(2)
        self.driver.quit()
        ...
        todoPage.MbTodoPage_ProcessRecord_Click(1)
        formPage = MbFormPage(self.driver)
        formPage.MbForm_Button_Click("维修完成")
        formPage.MbForm_ProcessHandle_Pop_QuerenButton_Click()
    ...
    def test_03( self ):
        ...
        formPage = MbFormPage(self.driver)
        formPage.MbMultiForm_AddButton_Click("归还已领设备")
        formPage.MbMultiForm_BathManagePage_Record_Tick("归还已领设备", [1, 2])
        formPage.MbMultiForm_BathManagePage_Button_Cick("归还已领设备","确定选择")
        ...
        self.driver.back()
        todoPage.MbTodoPage_ProcessRecord_Click(1)
        formPage.MbMultiForm_AddButton_Click("新设备明细")
        formPage.MbMultiForm_BathManagePage_Record_Tick("新设备明细", [2, 4])
        formPage.MbMultiForm_BathManagePage_Button_Cick("新设备明细","确定选择")
        formPage.MbForm_Button_Click("办理")
        formPage.MbForm_ProcessHandle_Pop_QuerenButton_Click()
        self.assertIn('成功', formPage.Public_GetAlertMessage(), msg="第二个人工任务办理失败")
        time.sleep(2)
    ...
    def test_04( self ):
        ...
        formPage = MbFormPage(self.driver)
        formPage.MbMultiForm_AddButton_Click("归还明细")
        time.sleep(2)
        formPage.MbMultiForm_BathManagePage_Record_Tick("归还明细", [1, 2])
        formPage.MbMultiForm_BathManagePage_Button_Cick("归还明细","确定选择")
        time.sleep(3)
        self.assertEqual("笔记本",formPage.MbMultiForm_GetTdValue("归还明细", 1, 2),msg="归还明细设备类别显示不正确")
        formPage.MbForm_Button_Click("提交")
        formPage.MbForm_ProcessHandle_Pop_QuerenButton_Click()
        self.assertIn('成功', formPage.Public_GetAlertMessage(), msg="第一个人工任务办理失败")
        time.sleep(5)
    ...
    def test_05( self ):
        ...
        formPage = MbFormPage(self.driver)
        formPage.MbMultiForm_AddButton_Click("报废明细")
        formPage.MbMultiForm_BathManagePage_Record_Tick("报废明细", [1, 2])
        formPage.MbMultiForm_BathManagePage_Button_Cick("报废明细","确定选择")
        self.assertEqual("D180734", formPage.MbMultiForm_GetTdValue("报废明细", 1, 2), msg="报废明细序列号显示不正确")
        formPage.MbForm_Button_Click("提交")
        formPage.MbForm_ProcessHandle_Pop_QuerenButton_Click()
        self.assertIn('成功', formPage.Public_GetAlertMessage(), msg="第一个人工任务办理失败")
        time.sleep(5)
