...
from qiqiao_page.pc_page.business_components.list_components import List
...
class FillReportTest(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.runtime = List(cls.driver)
        cls.runtime.clickPage("报平安")
    ...
    #     self.runtime.filterDataByPersonSelection("员工姓名","吴健伦")
    #     result=self.runtime.getFeildValues("员工姓名")
    #     print(result)
