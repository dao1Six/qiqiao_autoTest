...
class QuitAppTest_001(unittest.TestCase):
    ...
    def test_03( self ):
        ...
        self.assertEqual(businessPage.ListComponent_GetTable_Td_Value(1,4),"列表人员多选显示离职人员不正确")
        self.assertEqual(businessPage.ListComponent_GetTable_Td_Value(1,5),"列表人员多选显示离职人员不正确")
    ...
    def test_05( self ):
        ...
        self.assertEqual(formPage.User_GetMultiUserValue_readOnly("人员多选"),["刘言","王浩"])
