...
class ProcessAppTest_001(unittest.TestCase):
    ...
    def test_02( self ):
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['孙宁', '孙利军', '孙超', '周邵华', '周翠', '周煊', '周婉芳', '丘玉珍', '周士钦', '周琳', '周舂华', '梁华', '李旭明', '周楚桥', '孙宇阳', '周璎', '律强', '周晨安', '周可煊', '周丹晴', '朱浪锋', '罗琳月', '武探星', '孙莉', '孙培涵', '孙雪松', '周明梅', '孙鑫言', '周晋芳', '赵伶俐', '周灿', '林镇伟', '周佩意', '周璞', '周新爱', '周润泽', '郑涛', '周一诺', '孙财和', '彭政', '周铭', '孙建红', '李海绵', '周宇', '周兴', '赵金城', '张焕珽', '周君燕', '周臻妮', '周政', '吴茵婷', '杨李杰', '周永继', '赵墨晗', '孙中玲', '孙星瞳', '罗静文', '钟振东', '孙泽年', '周杨珍', '周潇', '周敏敏', '黄蕴彤', '周茜', '孙跃', '周俞臻', '邓基富', '孙铭燕', '刁惠云', '孙迪', '曾嘉凌', '马鑫', '周娟', '孙祎', '张月娟', '张鹏飞', '孙云宇', '孙裳', '周煊妮', '周俐臻', '吴健伦', '郑云龙', '孙怡淼', '周敏', '周唯臻', '孙保民', '周晨希', '刘海涛', '刘言', '周金铭', '周新月', '周金芸', '孙青海', '周树人', '赖家苣', '许廷燃', '周月清', '周美臻', '孙天学', '周虎', '周子贤', '刘秀维', '周英姿', '周文琴', '王栋一', '周泉君', '孙雅茹', '周美璎', '周舒臻', '庄荣填', '李嘉诚', '周若烯', '孙弋涵', '卢佳伟', '黎杨辉', '王浩', '周皖生', '周舟', '周佩臻', '周臻', '周才渊', '周冰莹', '程林', '孙言丽', '周叶萱', '周煊昊', '周文月', '孙亦珊', '孙慧颖', '周到钧', '周于钦', '孙青', '赵玉胜', '孙亚轩', '孙语', '赵新文', '周柔臻', '赵婧文', '孙珉珊', '范宇民', '郑谨'],msg="多部门标签人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
