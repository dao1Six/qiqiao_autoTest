...
class ProcessAppTest_001(unittest.TestCase):
    ...
    def test_02( self ):
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['梁华', '邓基富', '刁惠云', '张鹏飞',  '刘海涛', '庄荣填', '李嘉诚', '范宇民'],msg="多部门标签人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
    ...
    def test_03( self ):
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['梁华', '李旭明', '朱浪锋', '罗琳月', '武探星', '张焕珽', '吴茵婷', '罗静文',  '黄蕴彤', '邓基富', '刁惠云',  '张鹏飞', '吴健伦',  '刘海涛', '庄荣填', '李嘉诚', '黎杨辉', '王浩', '程林', '范宇民'],msg="表单部门字段人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['梁华', '邓基富', '刁惠云', '张鹏飞',  '刘海涛', '庄荣填', '李嘉诚', '范宇民'],msg="与上个任务办理人所在部门相关人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
