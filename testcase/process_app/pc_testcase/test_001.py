...
class ProcessAppTest_001(unittest.TestCase):
    ...
    def test_03( self ):
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['梁华', '李旭明', '朱浪锋', '罗琳月', '武探星', '张焕珽', '吴茵婷', '罗静文', '钟振东', '黄蕴彤', '邓基富', '刁惠云',  '张鹏飞', '吴健伦', '郑云龙', '刘海涛', '王栋一', '庄荣填', '李嘉诚', '黎杨辉', '王浩', '程林', '范宇民'],msg="表单部门字段人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['李旭明', '朱浪锋', '罗琳月', '武探星', '张焕珽', '吴茵婷', '罗静文', '钟振东', '黄蕴彤',  '吴健伦', '黎杨辉', '王浩', '程林'],msg="流程发起人的所在部门相关人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
