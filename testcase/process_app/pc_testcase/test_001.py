...
class ProcessAppTest_001(unittest.TestCase):
    ...
    def test_02( self ):
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['李旭明', '朱浪锋', '罗琳月', '罗静文',  '吴健伦', '黎杨辉', '王浩', '程林'],msg="多用户标签人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['周翠', '周煊', '周婉芳', '周士钦', '周舂华', '周楚桥', '周丹晴', '周明梅', '周佩意', '周新爱', '周润泽', '周一诺', '周铭', '周兴', '周君燕', '周臻妮', '周政', '周永继', '周潇', '周敏敏', '周俞臻', '周煊妮', '周俐臻', '周敏', '周唯臻', '周金铭', '周新月', '周金芸', '周月清', '周美臻', '周虎', '周子贤', '周英姿', '周泉君', '周舒臻', '李嘉诚', '王浩', '周佩臻', '周臻', '周才渊', '周煊昊', '周到钧', '周于钦', '周柔臻', '赵婧文'],msg="部门加用户标签人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['梁华', '邓基富', '刁惠云', '张鹏飞', '郑云龙', '刘海涛', '庄荣填', '李嘉诚', '范宇民'],msg="多部门标签人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
    ...
    def test_03( self ):
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['彭政','吴健伦'],msg="固定部门人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['梁华', '李旭明', '朱浪锋', '罗琳月', '武探星', '张焕珽', '吴茵婷', '罗静文',  '黄蕴彤', '邓基富', '刁惠云',  '张鹏飞', '吴健伦', '郑云龙', '刘海涛', '庄荣填', '李嘉诚', '黎杨辉', '王浩', '程林', '范宇民'],msg="表单部门字段人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['梁华', '邓基富', '刁惠云', '张鹏飞', '郑云龙', '刘海涛', '庄荣填', '李嘉诚', '范宇民'],msg="与上个任务办理人所在部门相关人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['李旭明', '朱浪锋', '罗琳月', '武探星', '张焕珽', '吴茵婷', '罗静文',  '黄蕴彤',  '吴健伦', '黎杨辉', '王浩', '程林'],msg="流程发起人的所在部门相关人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
    ...
    def test_04( self ):
        ...
        formPage.Form_Button_Click("办理")
        print(formPage.Form_Get_ProcessManagers())
        self.assertEqual(formPage.Form_Get_ProcessManagers(),['刘海涛'],msg="脚本人工任务办理者错误")
        formPage.Form_ProcessHandle_Pop_QuerenButton_Click()
