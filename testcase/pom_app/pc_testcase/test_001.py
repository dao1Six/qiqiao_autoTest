...
class PomAppTest_001(unittest.TestCase):
    ...
    def test_01( self ):
        ...
        self.assertEqual(businessPage.ListComponent_GetTable_Td_Value(1,24),"王浩",msg="订单创建人显示错误")
        ...
        self.assertEqual(businessPage.ListComponent_GetTable_Td_Value(1,27),"王浩",msg="开票回款计划创建人显示错误")
    ...
    def test_02( self ):
        ...
        self.assertEqual("1",excelReader.getRowValues(sheet,2)[0])
        self.assertEqual("创新技术中心->产品研发二部->产品规划组",excelReader.getRowValues(sheet,2)[1])
        self.assertEqual(orderid,excelReader.getRowValues(sheet,2)[26])
        self.assertEqual(25555554444.0,excelReader.getRowValues(sheet,2)[28])
        self.assertEqual(orderid,excelReader.getRowValues(sheet,2)[31])
        # self.assertEqual(233333.0,excelReader.getRowValues(sheet,2)[34])
        self.assertEqual(orderid,excelReader.getRowValues(sheet,2)[64])
        self.assertEqual(orderid,excelReader.getRowValues(sheet,2)[77])
        self.assertEqual("长江水坝管理系统",excelReader.getRowValues(sheet,2)[81])
